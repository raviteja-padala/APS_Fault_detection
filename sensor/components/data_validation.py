...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            base_df = utlis.convert_columns_float(df=base_df, exclude_columns=exclude_columns)
            train_df = utlis.convert_columns_float(df=train_df, exclude_columns=exclude_columns)
            test_df = utlis.convert_columns_float(df=test_df, exclude_columns=exclude_columns)
            ...
            utlis.write_yaml_file(file_path=self.data_validation_config.report_file_path,
